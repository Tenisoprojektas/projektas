...
const app = new PIXI.Application(windowDimensions.width,
...
$(window).on('mousemove touchmove', function (e) {
    ...
    for (var i = 0, length = Math.random()*userDefined.distribution; i < length; i++) {
...
setTimeout(function () {
    ...
    for (var i = 0, length = userDefined.distribution*100; i < length; i++) {
